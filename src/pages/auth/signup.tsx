            ...
            <section className="auth flex">
                <section>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <PasswordInput value={values.password} error={errors.password} touch={touched.password} blur={handleBlur} change={handleChange} className={errors.password && touched.password ? "input-error" : ""} name="password" label="Password" placeholder="enter your password" id="password" />
